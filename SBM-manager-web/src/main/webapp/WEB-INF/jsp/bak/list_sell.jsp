...
<body>
	...
	<div id="sk_body" class="container">
		...
		<div id="sk_right">
			<div class="sk_book">
				<h3>你出售的书籍</h3>
				<form
					action="${pageContext.request.contextPath }/wish_upload.action?state=0"
					method="post" enctype="multipart/form-data" name="input_file">
					<table>
						<tr>
						...
						<tr>
	  						...
	  						<td><textarea id="book_requ" name="book_instru" placeholder="你有什么对于书友的请求" rows="" cols=""></textarea></td>
	  						<!-- name="info" -->
	  					</tr>
						<tr>
							<td class="sk_info"><label for="address">附加</label></td>
							<td><textarea id="info" name="additional"
									placeholder="你对于这本还有什么补充说明的" rows="" cols=""></textarea></td>
						</tr>
	...
	<div class="container">
		...
		<div id="lb_href">
			返回&nbsp;<a href="wish_list.html">心愿单&nbsp;<span
