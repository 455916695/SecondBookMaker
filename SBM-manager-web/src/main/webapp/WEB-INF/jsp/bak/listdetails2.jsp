...
<!--网页最上面的横条-->
 	<div id="header">
  	...
  	<div class="ld_fix">
  		<h3>商家信息</h3>
  		<ul>
  			<li><span>姓名</span><p>${cWish.userinfo.user_name}</p></li>
  			<li><span>性别</span><p>${cWish.userinfo.user_sex}</p></li>
  			<li><span>手机号码</span><p>${cWish.userinfo.user_phone}</p></li>
  			<li><span>QQ/微信</span><p>${cWish.userinfo.user_qq}</p></li>
  			<li><span>附加</span><p>${cWish.userinfo.user_instro}</p></li>
  		</ul>
  	...
  	<div class="container">
  		<div id="ld_body">
  			<div class="ld_left">
  				...
  				<span id="praiseTip">已有${cWish.onPrise}&nbsp; 赞</span></div>
  				<div class="ld_center">
	  				<div class="ld_info">
			  			<div class="ld_photo">
			  				<img src="<%=url %>/${cWish.userinfo.user_headimg}" height="100" width="100"/>
			  			</div>
			  			<div class="ld_name">
			  				<span>${cWish.userinfo.user_name}</span>
			  			</div>
			  			<div class="ld_time">
			  				<time>${cWish.book_publish }</time>
			  			</div>
		  			</div>
	  				<div class="ld_person">
	  					<ul>
	  						<li>书名：<span>${cWish.book_name }</span></li>
	  						<li>要求：<span>${cWish.book_state }</span></li>
	  						<li>报酬：<span>${cWish.book_price}</span></li>
	  						<li>请求：
	  							<div class="ld_request">
	  								<span>${cWish.book_instru }</sapn>
	  							</div>
	  						</li>
	  						<li>图片：
	  							<div class="ld_books">
		  							<div class="ld_book">
		  								<img src="<%=url %>/${cWish.main_img }" height="120" width="86"/>
		  							</div>
		  							<div class="ld_book">
  			...
  			<div class="ld_right">
  				<div class="ld_comments">
  					...
  					<div class="ld_text">
  					<form action="${pageContext.request.contextPath }/comment_saveSession.action?wid=${cWish.wid }" method="post">
