	  		...
	  		<ul class="hp_ul">
	  			<li>
					<a href="http://localhost:8847/"><!-- <span class="glyphicon glyphicon-home"></span>&nbsp; -->首页</a></li><li >
	  				...
	  				<a href="http://localhost:8853/common/bookcase"><!--<span class="glyphicon glyphicon-tasks"></span>&nbsp;-->书架</a></li><li class="active">
	  				<a href="javascript:void(0)"><span class="glyphicon glyphicon-phone"></span>&nbsp;客户端</a></li><li >
